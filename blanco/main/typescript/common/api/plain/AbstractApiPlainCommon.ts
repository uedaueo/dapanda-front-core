...
/**
 * 共通エラーResponseを定義するためのダミーAPIです。
 */
export abstract class AbstractApiPlainCommon extends ApiBase {
    /**
     * 規定値   [/api/ApiPlainCommon]
     */
    private _locationURL: string = "/api/ApiPlainCommon";
